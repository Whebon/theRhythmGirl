...
import theRhythmGirl.powers.CommonPower;

import static theRhythmGirl.RhythmGirlMod.makeCardPath;

public class DefaultCommonPower extends AbstractRhythmGirlCard {
    ...
    public static final String ID = RhythmGirlMod.makeID(DefaultCommonPower.class.getSimpleName());
