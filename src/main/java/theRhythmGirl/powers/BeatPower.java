...
public class BeatPower extends AbstractPower implements CloneablePowerInterface {
    ...
    //todo: redesign Beat into a custom visual instead of a power

    // We create 2 new textures *Using This Specific Texture Loader* - an 84x84 image and a 32x32 one.
    // There's a fallback "missing texture" image, so the game shouldn't crash if you accidentally put a non-existent file.
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("beat_power84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("beat_power32.png"));
